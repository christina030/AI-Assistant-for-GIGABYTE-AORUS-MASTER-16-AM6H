...
| Qwen2.5-1.5B-Instruct (Q8_0)  | 1.76 GB | ~2.0 GB | 0.036s | 97.10 | 速度快：反應時間最短，生成速度最快，適合需要即時回應的場景。 |
| Llama-3.2-3B-Instruct (Q4_K_M)  | 1.88 GB | ~2.6 GB | 0.060s | 63.76 | 穩定輸出：生成速度略低於 Qwen 3B，效能指標與 Qwen 3B 非常接近，同屬 3B 級別的優秀選擇。首字延遲低於 Qwen 3B，但在繁體中文語境的在地化表現可能因任務而異。 |
